        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-[#f2f5f8] border-b border-slate-200">
              ...
              <th className="py-3.5 px-6 text-[13px] font-bold text-[#203147] tracking-wide text-center">Actions</th>
            </tr>
          </thead>
          <tbody>
                ...
                <tr key={index} className="border-b border-slate-100 last:border-0 hover:bg-slate-50/50">
                  ...
                  <td className="py-4 px-6">
                    <div className="flex items-center justify-center gap-2">
                      <button className="bg-[#1a6ac9] hover:bg-blue-700 text-white text-xs font-medium px-4 py-1.5 rounded shadow-sm">
                        View
                      </button>
                      <button className="bg-[#f0ad4e] hover:bg-orange-500 text-white text-xs font-medium px-4 py-1.5 rounded shadow-sm">
                        Edit
                      </button>
                      <button className="bg-[#d9534f] hover:bg-red-600 text-white text-xs font-medium px-4 py-1.5 rounded shadow-sm">
                        Delete
                      </button>
                    </div>
                  </td>
